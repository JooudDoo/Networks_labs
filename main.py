...
if __name__ == '__main__':
    parser = DNSParser(parsingTags=[Tag.title, Tag.price, Tag.availability, Tag.description, Tag.serviceRating, Tag.reviewsCount])
    ...
    #parser.parseDNSCatalog(url, pages=999)
    url = 'https://www.dns-shop.ru/catalog/17a899cd16404e77/processory/?order=6&stock=now-today-tomorrow-later-out_of_stock'
    parser.parseDNSCatalog(url, pages=999)
    parser.exportData('CPUs 2')
    del parser
